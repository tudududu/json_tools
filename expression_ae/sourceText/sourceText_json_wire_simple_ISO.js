// sourceText_json_wire_simple_ISO_aware 260213
...
try {
  ...
  var txt = getText(data, orientedId, baseId, directId, DATA_KEY, desiredLine, compOrientation);
  passesDirFilter(data) ? txt : "";
} catch (e) {
  "";
}